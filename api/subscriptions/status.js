...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Get the actual API key if it exists
        const apiKey = useOwnApiKey ? subscriptionData.own_api_key : null;
        ...
        return res.status(200).json({
            ...
            subscription: subscriptionData ? {
                ...
                useOwnApiKey: subscriptionData.use_own_api_key // Include the use_own_api_key flag
            } : null
        });
    } catch (error) {
